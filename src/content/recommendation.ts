export const recommendationCopy = {
  en: {
    ...
    reviewed: 'Decision reviewed', steam: 'View on Steam', tool: 'Get CrossOver', preferred: 'Preferred route',
  ...
  'zh-CN': {
    ...
    reviewed: '结论复核日期', steam: '查看 Steam 游戏', tool: '获取 CrossOver', preferred: '首选方案',
