...
export const messages = {
  en: {
    ...
    explorer: {
      ...
      emptyBody: 'Clear the search or choose another recommendation filter. Games outside this catalog are not endorsed.',
      reset: 'Reset samples',
    },
    gameDetail: {
      back: 'Back to sample library',
      steamAppId: 'Steam App ID',
      ...
      notFoundTitle: 'This game is not in the research preview.',
      notFoundBody:
        'The current detail flow is limited to games with replayable evidence in the sample library.',
      notFoundAction: 'Browse available samples',
  ...
  'zh-CN': {
    ...
    explorer: {
      ...
      emptyBody: '请清空搜索或切换建议分类；清单外的游戏不在当前推荐范围。',
      reset: '重置示例',
    },
    gameDetail: {
      back: '返回示例游戏库',
      ...
      notFoundTitle: '这款游戏不在当前研究预览中。',
      notFoundBody: '当前详情流程仅覆盖示例游戏库中具有可回放证据的游戏。',
      notFoundAction: '浏览现有样本',
