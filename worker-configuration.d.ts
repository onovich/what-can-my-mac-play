/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 211464b248adf2075f52a7a6c06a9aa1)
// Runtime types generated with workerd@1.20260828.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	STEAM_API_ROUTE_RATE_LIMITER: RateLimit;
	STEAM_LIBRARY_USER_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	STEAM_LIBRARY_LOOKUP_ENABLED: false;
	STEAM_WEB_API_KEY: string;
	STEAM_DAILY_BUDGET: DurableObjectNamespace<import("./worker/index").SteamDailyBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SteamDailyBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STEAM_LIBRARY_LOOKUP_ENABLED" | "STEAM_WEB_API_KEY">> {}
}
