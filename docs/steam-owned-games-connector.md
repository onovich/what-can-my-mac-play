...
This is intentional: the endpoint must not be enabled until rate limiting and
live public/private/empty account tests are complete.
...
2. Add a rate limiter with a conservative budget below Valve's published
   100,000-calls-per-day limit.
...
and [Steam Web API Terms of Use](https://steamcommunity.com/dev/apiterms).
